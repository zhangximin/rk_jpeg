 ...
 * 1 = 64-bit endianess */
#ifndef VS8270_INPUT_SWAP_32_YUV
#define VS8270_INPUT_SWAP_32_YUV                   0
#endif

/* The input image's 16-bit swap: 0 or 1
 * This defines the 16-bit endianess of the ASIC input YUV
 */
#ifndef VS8270_INPUT_SWAP_16_YUV
#define VS8270_INPUT_SWAP_16_YUV                   1
#endif

/* The input image's 8-bit swap: 0 or 1
 * This defines the byte endianess of the ASIC input YUV
 */
#ifndef VS8270_INPUT_SWAP_8_YUV
#define VS8270_INPUT_SWAP_8_YUV                    1
#endif

/* The input image's 32-bit swap: 0 or 1
 * This defines the 32-bit endianess of the ASIC input RGB16
 * 1 = 64-bit endianess */
#ifndef VS8270_INPUT_SWAP_32_RGB16
#define VS8270_INPUT_SWAP_32_RGB16                 0
#endif

/* The input image's 16-bit swap: 0 or 1
 * This defines the 16-bit endianess of the ASIC input RGB16
 */
#ifndef VS8270_INPUT_SWAP_16_RGB16
#define VS8270_INPUT_SWAP_16_RGB16                 1
#endif

/* The input image's byte swap: 0 or 1
 * This defines the byte endianess of the ASIC input RGB16
 */
#ifndef VS8270_INPUT_SWAP_8_RGB16
#define VS8270_INPUT_SWAP_8_RGB16                  0
#endif

/* The input image's 32-bit swap: 0 or 1
 * This defines the 32-bit endianess of the ASIC input RGB32
 * 1 = 64-bit endianess */
#ifndef VS8270_INPUT_SWAP_32_RGB32
#define VS8270_INPUT_SWAP_32_RGB32                 0
#endif

/* The input image's 16-bit swap: 0 or 1
 * This defines the 16-bit endianess of the ASIC input RGB32
 */
#ifndef VS8270_INPUT_SWAP_16_RGB32
#define VS8270_INPUT_SWAP_16_RGB32                 0
#endif

/* The input image's byte swap: 0 or 1
 * This defines the byte endianess of the ASIC input RGB32
 */
#ifndef VS8270_INPUT_SWAP_8_RGB32
#define VS8270_INPUT_SWAP_8_RGB32                  0
#endif
 ...
 */
#ifndef VS8270_IRQ_DISABLE
#define VS8270_IRQ_DISABLE                         0
#endif
 ...
 *          AXI [1,16]
 */
#ifndef VS8270_BURST_LENGTH
#define VS8270_BURST_LENGTH                               16
#endif

/* INCR type burst mode                          */
/* 0 allowe INCR type bursts                     */
/* 1 disable INCR type and use SINGLE instead    */
#ifndef VS8270_BURST_INCR_TYPE_ENABLED
#define VS8270_BURST_INCR_TYPE_ENABLED                    0
#endif
...
#ifndef VS8270_BURST_DATA_DISCARD_ENABLED
#define VS8270_BURST_DATA_DISCARD_ENABLED                 0
#endif

/* AXI bus read and write ID values used by HW. 0 - 255 */
#ifndef VS8270_AXI_READ_ID
#define VS8270_AXI_READ_ID                                0
#endif

#ifndef VS8270_AXI_WRITE_ID
#define VS8270_AXI_WRITE_ID                              0
#endif

/* End of "ASIC bus interface configuration values" */

/* ASIC internal clock gating control. 0 - disabled, 1 - enabled */
#ifndef VS8270_ASIC_CLOCK_GATING_ENABLED
#define VS8270_ASIC_CLOCK_GATING_ENABLED                  0
#endif
